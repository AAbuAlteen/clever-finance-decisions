...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 p-6">
                ...
                <div className="h-48">
                  <ChartContainer config={chartConfig}>
                    <LineChart data={balanceHistory}>
                      ...
                      <Line type="monotone" dataKey="balance" stroke="var(--color-balance)" strokeWidth={3} dot={{
        ...
        <Card className="mb-8 bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          <CardContent className="p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button onClick={() => handleDecision('save')} className="bg-emerald-500 hover:bg-emerald-600 text-white border-0 text-base px-6 py-3 rounded-full shadow-lg transition-all duration-200 hover:shadow-xl">
                Wait & Save More
              </Button>
              <Button onClick={() => handleDecision('finance')} className="bg-amber-500 hover:bg-amber-600 text-white border-0 text-base px-6 py-3 rounded-full shadow-lg transition-all duration-200 hover:shadow-xl">
                Finance It
              </Button>
              <Button onClick={() => handleDecision('buy')} className="bg-orange-500 hover:bg-orange-600 text-white border-0 text-base px-6 py-3 rounded-full shadow-lg transition-all duration-200 hover:shadow-xl">
                Buy Now
              </Button>
            </div>
          </CardContent>
